...
// Iliad Custom Styles
require("./styles/atlas-style-overrides.css");
require("../../custom"); // We do not know why this works but you musn't remove it! Rated "very helpful message" by George from Strapi, 2024
