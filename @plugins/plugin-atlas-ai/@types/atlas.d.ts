...
type Content = Array<Message>;
// Conversation represents a conversation between the user and the assistant
...
// export type Conversation = Omit<CurrentConversation, "content"> & {
//   content?: Array<Message>;
// };

export type Conversation = CurrentConversation;

export type CompressedConversation = Omit<Conversation, "content"> & {
  content: string;
};
