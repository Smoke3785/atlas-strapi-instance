...
exports.default = {
    register: function (app) {
        ...
        app.customFields.register({
            ...
            intlLabel: {
                id: "".concat(pluginId_1.default, ".customFields.ElectronRelation.label"),
                defaultMessage: "Electron Relation",
            },
            intlDescription: {
                id: "".concat(pluginId_1.default, ".customFields.ElectronRelation.description"),
                defaultMessage: "Relation to electron",
            },
            components: {
                Input: function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                    return [2 /*return*/, Promise.resolve().then(function () { return require("./components/ExampleInput"); })];
                }); }); },
            },
        });
        var plugin = {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all(locales.map(function (locale) {
                                return Promise.resolve("".concat("./translations/".concat(locale, ".json"))).then(function (s) { return require(s); }).then(function (_a) {
                                    var data = _a.default;
                                    return {
